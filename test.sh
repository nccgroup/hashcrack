...
python3 hashcrack.py --hash tests/apachemd5.txt
...
python3 hashcrack.py -i tests/sha256crypt.txt
python3 hashcrack.py -i tests/sha512crypt.txt

#autodetect PDF
python3 hashcrack.py -i tests/test-hashcat.pdf
